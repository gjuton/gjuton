<!--
This file replaces README.md at the next release. It exists because the coordinates
below only resolve once that release is published, while README.md has to stay
correct for the newest published version. `docs/releasing.md` says when to swap them;
delete this comment as part of that step.
-->
