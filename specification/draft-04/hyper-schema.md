...
<table class="header"><tbody><tr><td class="left">Internet Engineering Task Force</td><td class="right">G. Luff, Ed.</td></tr><tr><td class="left">Internet-Draft</td><td class="right"></td></tr><tr><td class="left">Intended status: Informational</td><td class="right">K. Zyp</td></tr><tr><td class="left">Expires: August 26, 2017</td><td class="right">SitePen (USA)</td></tr><tr><td class="left"></td><td class="right">G. Court</td></tr><tr><td class="left"></td><td class="right">2013</td></tr></tbody></table>
...
*   3.1. [Design Considerations](#rfc.section.3.1)

*   4\. [Schema keywords](#rfc.section.4)

*   4.1. [links](#rfc.section.4.1)

*   4.1.1. [Multiple links per URI](#rfc.section.4.1.1)

*   4.2. [fragmentResolution](#rfc.section.4.2)

*   4.2.1. [json-pointer fragment resolution](#rfc.section.4.2.1)

*   4.3. [media](#rfc.section.4.3)

*   4.3.1. [Properties of "media"](#rfc.section.4.3.1)
*   4.3.2. [Example](#rfc.section.4.3.2)

*   4.4. [readOnly](#rfc.section.4.4)
*   4.5. [pathStart](#rfc.section.4.5)

*   5\. [Link Description Object](#rfc.section.5)

*   5.1. [href](#rfc.section.5.1)

*   5.1.1. [URI Templating](#rfc.section.5.1.1)

*   5.2. [rel](#rfc.section.5.2)

*   5.2.1. [Fragment resolution with "root" links](#rfc.section.5.2.1)
*   5.2.2. [Security Considerations for "self" links](#rfc.section.5.2.2)

*   5.3. [title](#rfc.section.5.3)
*   5.4. [targetSchema](#rfc.section.5.4)

*   5.4.1. [Security Considerations for "targetSchema"](#rfc.section.5.4.1)

*   5.5. [mediaType](#rfc.section.5.5)

*   5.5.1. [Security concerns for "mediaType"](#rfc.section.5.5.1)

*   5.6. [Submission Link Properties](#rfc.section.5.6)

*   5.6.1. [method](#rfc.section.5.6.1)
*   5.6.2. [encType](#rfc.section.5.6.2)
*   5.6.3. [schema](#rfc.section.5.6.3)

*   6\. [IANA Considerations](#rfc.section.6)

*   6.1. [Registry of Link Relations](#rfc.section.6.1)
...
*   Appendix A. [Change Log](#rfc.appendix.A)
...
This specification will use the terminology defined by the [JSON Schema core specification](#json-schema-core) \[json-schema-core\]. It is advised that readers have a copy of this specification.
...
The terms "schema", "instance", "property" and "item" are to be interpreted as defined in the [JSON Schema core specification](#json-schema-core) \[json-schema-core\].
...
# [3.1.](#rfc.section.3.1) Design Considerations
...
# [4.](#rfc.section.4) Schema keywords

# [4.1.](#rfc.section.4.1) links
...
# [4.1.1.](#rfc.section.4.1.1) Multiple links per URI
...
# [4.2.](#rfc.section.4.2) fragmentResolution
...
If the instance is described by a schema providing the a link with "root" relation, or such a link is provided in using the [HTTP Link header](#RFC5988) \[RFC5988\], then the target of the "root" link should be considered the document root for the purposes of all fragment resolution methods that use the document structure (such as "json-pointer"). The only exception to this is the resolution of "root" links themselves.

# [4.2.1.](#rfc.section.4.2.1) json-pointer fragment resolution

The "json-pointer" fragment resolution protocol uses a [JSON Pointer](#json-pointer) \[json-pointer\] to resolve fragment identifiers in URIs within instance representations.

# [4.3.](#rfc.section.4.3) media
...
# [4.3.1.](#rfc.section.4.3.1) Properties of "media"

The value of the "media" keyword MAY contain any of the following properties:

# [4.3.1.1.](#rfc.section.4.3.1.1) binaryEncoding
...
# [4.3.1.2.](#rfc.section.4.3.1.2) type
...
# [4.3.2.](#rfc.section.4.3.2) Example
...
# [4.5.](#rfc.section.4.5) pathStart

This property is a URI that defines what the instance's URI MUST start with in order to validate. The value of the "pathStart" property MUST be resolved relative to the closest URI Resolution Scope (as defined in the [JSON Schema core specification](#json-schema-core) \[json-schema-core\]), using the rules from [RFC 3986, Sec 5](#RFC3986) \[RFC3986\].
...
# [5.](#rfc.section.5) Link Description Object
...
The link description format can be used without JSON Schema, and use of this format can be declared by referencing the normative link description schema as the schema for the data structure that uses the links. The URI of the normative link description schema is: [http://json-schema.org/links](https://json-schema.org/links) (latest version) or [http://json-schema.org/draft-04/links](https://json-schema.org/draft-04/links) (draft-04 version).
...
# [5.1.1.](#rfc.section.5.1.1) URI Templating
...
# [5.1.1.1.](#rfc.section.5.1.1.1) Pre-processing

The [URI Template specification](#RFC6570) \[RFC6570\] restricts the set of characters available for variable names. Property names in JSON, however, can be any UTF-8 string.
...
# [5.1.1.1.1.](#rfc.section.5.1.1.1.1) Bracket escaping
...
# [5.1.1.1.2.](#rfc.section.5.1.1.1.2) Replacing $
...
# [5.1.1.1.3.](#rfc.section.5.1.1.1.3) Choice of special-case values
...
# [5.1.1.1.4.](#rfc.section.5.1.1.1.4) Examples
...
# [5.1.1.2.](#rfc.section.5.1.1.2) Values for substitution
...
# [5.1.1.2.1.](#rfc.section.5.1.1.2.1) Converting to strings
...
# [5.1.1.3.](#rfc.section.5.1.1.3) Missing values
...
Relationship definitions SHOULD NOT be media type dependent, and users are encouraged to utilize existing accepted relation definitions, including those in existing relation registries (see [RFC 4287](#RFC4287) \[RFC4287\]). However, we define these relations here for clarity of normative interpretation within the context of JSON Schema defined relations:
...
# [5.2.1.](#rfc.section.5.2.1) Fragment resolution with "root" links
...
# [5.2.2.](#rfc.section.5.2.2) Security Considerations for "self" links
...
# [5.4.](#rfc.section.5.4) targetSchema
...
# [5.4.1.](#rfc.section.5.4.1) Security Considerations for "targetSchema"
...
# [5.5.](#rfc.section.5.5) mediaType

The value of this property is advisory only, and represents the media type [RFC 2046](#RFC2046) \[RFC2046\], that is expected to be returned when fetching this resource. This property value MAY be a media range instead, using the same pattern defined in [RFC 2161, section 14.1 - HTTP "Accept" header](#RFC2616) \[RFC2616\].
...
# [5.5.1.](#rfc.section.5.5.1) Security concerns for "mediaType"
...
# [5.6.](#rfc.section.5.6) Submission Link Properties
...
# [5.6.1.](#rfc.section.5.6.1) method
...
# [5.6.2.](#rfc.section.5.6.2) encType
...
# [5.6.3.](#rfc.section.5.6.3) schema
...
Geraint Luff (editor) Luff Cambridge, UK EMail: [\[email protected\]](/cdn-cgi/l/email-protection#45293023232221052228242c296b262a28)

Kris Zyp Zyp SitePen (USA) 530 Lytton Avenue Palo Alto, CA 94301, USA Phone: +1 650 968 8787 EMail: [\[email protected\]](/cdn-cgi/l/email-protection#305b425943704359445540555e1e535f5d)

Gary Court Court Calgary, AB, Canada EMail: [\[email protected\]](/cdn-cgi/l/email-protection#d5b2b4a7acfbb6baa0a7a195b2b8b4bcb9fbb6bab8)