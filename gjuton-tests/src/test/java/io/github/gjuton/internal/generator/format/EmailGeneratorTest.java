...
class EmailGeneratorTest {
    ...
    void producesValueContainingAt() {
        var schema = StringSchema.builder().rawFormat("email").build();
    ...
    void composesWithPattern() {
        var schema = StringSchema.builder().rawFormat("email").pattern("@[a-z]+\\.com$").build();
        var generator = new EmailGenerator(withSeed(42), schema);
    ...
    void firstResultMatchesMinLengthExactly() {
        ...
        var schema = StringSchema.builder().rawFormat("email").minLength(18).build();
        var generator = new EmailGenerator(withSeed(42), schema);
    ...
    void secondResultMatchesMaxLengthExactly() {
        var schema = StringSchema.builder().rawFormat("email").maxLength(30).build();
        var generator = new EmailGenerator(withSeed(42), schema);
    ...
    void exactBoundaryLengthAcceptsCanonical() {
        ...
        var schema = StringSchema.builder().rawFormat("email").minLength(6).maxLength(6).build();
        var generator = new EmailGenerator(withSeed(42), schema);
    ...
    void tightMaxLengthFiltersTooLongCandidates() {
        ...
        var schema = StringSchema.builder().rawFormat("email").maxLength(10).build();
        var generator = new EmailGenerator(withSeed(42), schema);
    ...
    void acceptsMinLengthBeyondRandomPhaseCeiling() {
        ...
        var schema = StringSchema.builder().rawFormat("email").minLength(40).maxLength(60).build();
        var generator = new EmailGenerator(withSeed(42), schema);
    ...
    void shortPhaseDoesNotExceedRfcLocalPartCap() {
        ...
        var schema = StringSchema.builder().rawFormat("email").minLength(70).maxLength(80).build();
        var generator = new EmailGenerator(withSeed(42), schema);
    ...
    void composesWithLengthBounds() {
        var schema = StringSchema.builder().rawFormat("email").minLength(15).maxLength(25).build();
        var generator = new EmailGenerator(withSeed(42), schema);
