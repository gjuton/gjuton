...
Note that draft-07 core and validation are backwards-compatible with draft-06. For more information, see that draft's [migration notes](../../draft-07/json-schema-release-notes).
...
| `"propertyNames"` | added | takes a schema which validates the _names_ of all properties rather than their values |
...
[Edit this page on Github](https://github.com/json-schema-org/website/blob/main/pages/draft-06/json-schema-release-notes.md)
